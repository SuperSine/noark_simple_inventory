...
*/    
    ...
    public function get_assign_docnumber(){
        $doc_number = Input::get('doc_number');

        $user_id = Auth::user()->id;

        Cache::put("userid_$user_id", $doc_number,20);
        
    }

    public function get_fetch_docnumber(){
        $user_id = Auth::user()->id;
        $doc_number = Cache::get("userid_$user_id",function(){return '';});
    ...
    private function _attachDocNumber($data){
        $user_id = Auth::user()->id;
        $doc_number = Cache::get("userid_$user_id",function(){return '';});
    ...
    public function get_checkin_fields($code=null)
    {
        ...
        if($items == null)
        {
            exit;/*no callback to the client siden*/
        }
        ...
        $data = $this->_attachDocNumber($data);
    ...
    public function get_transaction_overview($id = null)
    {
        ...
        $columns = array(
            ...
            'transactions.doc_number as Doc #'
    ...
    public function get_transaction_advanced($id = null)
    {
        ...
        $columns = array(
            ...
            'transactions.items_id as iid',
            'transactions.doc_number as Doc #',
            'transactions.pd_date as PrdDate',
        );
